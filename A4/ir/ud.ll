...
; <label>:37                                      ; preds = %26, %10
  ...
  %42 = getelementptr inbounds [50 x [50 x i64]]* @a, i32 0, i64 %41
  %43 = getelementptr inbounds [50 x i64]* %42, i32 0, i64 %39
...
; <label>:50                                      ; preds = %6
  ...
  %54 = getelementptr inbounds [50 x i64]* @b, i32 0, i64 %53
...
; <label>:58                                      ; preds = %1
  %59 = load i32* %nmax, align 4
  %60 = load i32* %n, align 4
  %61 = call i32 @ludcmp(i32 %59, i32 %60)
  store i32 %61, i32* %chkerr, align 4
  ret void
}
