...
@.str = private unnamed_addr constant [9 x i8] c"cnt: %d\0A\00", align 1
...
define i32 @main() #0 {
  ...
  %9 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0), i32 %8)
  %10 = load volatile i32* %cnt, align 4
  ret i32 %10
}
