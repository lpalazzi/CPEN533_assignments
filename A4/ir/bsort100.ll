...
; Function Attrs: nounwind uwtable
define i32 @ttime() #0 {
  %buffer = alloca %struct.tms, align 8
  %utime = alloca i32, align 4
  %1 = getelementptr inbounds %struct.tms* %buffer, i32 0, i32 0
  %2 = load i64* %1, align 8
  %3 = sitofp i64 %2 to double
  %4 = fdiv double %3, 6.000000e+01
  %5 = fmul double %4, 1.000000e+03
  %6 = fptosi double %5 to i32
  store i32 %6, i32* %utime, align 4
  %7 = load i32* %utime, align 4
  ret i32 %7
}
...
; <label>:7                                       ; preds = %4
  ...
  %9 = load i32* %fact, align 4
  %10 = mul nsw i32 %8, %9
  %11 = load i8* inttoptr (i64 2149580801 to i8*), align 1
  %12 = sext i8 %11 to i32
  %13 = mul nsw i32 %10, %12
  %14 = load i32* %Index, align 4
