...
define i32 @main() #0 {
  ...
  %a = alloca [200 x i16], align 16
  %b = alloca [200 x i16], align 16
  %c = alloca i16, align 2
  %output = alloca [200 x i64], align 16
  %d = alloca i64, align 8
  %e = alloca [1 x i32], align 4
  store i32 0, i32* %1
  %2 = bitcast [200 x i16]* %a to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* bitcast ([200 x i16]* @main.a to i8*), i64 400, i32 16, i1 false)
  %3 = bitcast [200 x i16]* %b to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %3, i8* bitcast ([200 x i16]* @main.b to i8*), i64 400, i32 16, i1 false)
  store i16 3, i16* %c, align 2
  store i64 43690, i64* %d, align 8
  %4 = bitcast [1 x i32]* %e to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %4, i8* bitcast ([1 x i32]* @main.e to i8*), i64 4, i32 4, i1 false)
  %5 = getelementptr inbounds [200 x i16]* %a, i32 0, i32 0
  %6 = getelementptr inbounds [200 x i16]* %b, i32 0, i32 0
  %7 = load i16* %c, align 2
  call void @vec_mpy1(i16* %5, i16* %6, i16 signext %7)
  %8 = getelementptr inbounds [200 x i16]* %a, i32 0, i32 0
  %9 = getelementptr inbounds [200 x i16]* %b, i32 0, i32 0
  %10 = load i16* %c, align 2
  %11 = sext i16 %10 to i64
  %12 = getelementptr inbounds [200 x i64]* %output, i32 0, i32 0
  %13 = call i64 @mac(i16* %8, i16* %9, i64 %11, i64* %12)
  %14 = trunc i64 %13 to i16
  store i16 %14, i16* %c, align 2
  %15 = getelementptr inbounds [200 x i16]* %a, i32 0, i32 0
  %16 = getelementptr inbounds [200 x i16]* %b, i32 0, i32 0
  %17 = getelementptr inbounds [200 x i64]* %output, i32 0, i32 0
  call void @fir(i16* %15, i16* %16, i64* %17)
  %18 = getelementptr inbounds [200 x i16]* %a, i32 0, i32 0
  %19 = getelementptr inbounds [200 x i16]* %b, i32 0, i32 0
  %20 = getelementptr inbounds [200 x i64]* %output, i32 0, i32 0
  call void @fir_no_red_ld(i16* %18, i16* %19, i64* %20)
  %21 = getelementptr inbounds [200 x i16]* %a, i32 0, i32 0
  %22 = getelementptr inbounds [200 x i16]* %b, i32 0, i32 0
  %23 = load i64* %d, align 8
  %24 = call i64 @latsynth(i16* %21, i16* %22, i64 100, i64 %23)
  store i64 %24, i64* %d, align 8
  %25 = getelementptr inbounds [200 x i16]* %a, i32 0, i32 0
  %26 = getelementptr inbounds [200 x i16]* %b, i32 0, i32 0
  %27 = getelementptr inbounds [200 x i64]* %output, i32 0, i64 100
  %28 = getelementptr inbounds [200 x i64]* %output, i32 0, i32 0
  call void @iir1(i16* %25, i16* %26, i64* %27, i64* %28)
  %29 = load i64* %d, align 8
  %30 = getelementptr inbounds [1 x i32]* %e, i32 0, i64 0
  %31 = load i32* %30, align 4
  %32 = sext i32 %31 to i64
  %33 = load i64* %d, align 8
  %34 = getelementptr inbounds [200 x i16]* %a, i32 0, i32 0
  %35 = load i16* %c, align 2
  %36 = call i64 @codebook(i64 %29, i64 1, i64 17, i64 %32, i64 %33, i16* %34, i16 signext %35, i16 signext 1)
  %37 = trunc i64 %36 to i32
  %38 = getelementptr inbounds [1 x i32]* %e, i32 0, i64 0
  store i32 %37, i32* %38, align 4
  %39 = getelementptr inbounds [200 x i16]* %a, i32 0, i32 0
  %40 = getelementptr inbounds [200 x i16]* %b, i32 0, i32 0
  call void @jpegdct(i16* %39, i16* %40)
  ret i32 0
}
