...
define void @main() #0 {
  ...
  call void @Print_matrix([20 x i32]* getelementptr inbounds ([20 x [20 x i32]]* @ResultArray, i32 0, i32 0))
  ret void
}
...
; Function Attrs: nounwind uwtable
define void @Print_matrix([20 x i32]* %Array) #0 {
  %1 = alloca [20 x i32]*, align 8
...
; <label>:9                                       ; preds = %6
  ...
  %14 = load [20 x i32]** %1, align 8
  %15 = getelementptr inbounds [20 x i32]* %14, i64 %13
  %16 = getelementptr inbounds [20 x i32]* %15, i32 0, i64 %11
  %17 = load i32* %16, align 4
  %18 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %17)
  br label %19

; <label>:19                                      ; preds = %9
  %20 = load i32* %InnerIndex, align 4
  %21 = add nsw i32 %20, 1
  store i32 %21, i32* %InnerIndex, align 4
  br label %6
...
; <label>:23                                      ; preds = %22
  %24 = load i32* %OuterIndex, align 4
  %25 = add nsw i32 %24, 1
  store i32 %25, i32* %OuterIndex, align 4
  br label %2
...
; <label>:9                                       ; preds = %6
  %10 = load i32* %OuterIndex, align 4
  %11 = mul nsw i32 5, %10
  %12 = load i32* %InnerIndex, align 4
  %13 = mul nsw i32 6, %12
  %14 = add nsw i32 %11, %13
  %15 = load i32* %InnerIndex, align 4
  %16 = sext i32 %15 to i64
  %17 = load i32* %OuterIndex, align 4
  %18 = sext i32 %17 to i64
  %19 = load [20 x i32]** %1, align 8
  %20 = getelementptr inbounds [20 x i32]* %19, i64 %18
  %21 = getelementptr inbounds [20 x i32]* %20, i32 0, i64 %16
  store i32 %14, i32* %21, align 4
  br label %22

; <label>:22                                      ; preds = %9
  %23 = load i32* %InnerIndex, align 4
  %24 = add nsw i32 %23, 1
  store i32 %24, i32* %InnerIndex, align 4
  br label %6
...
; <label>:26                                      ; preds = %25
  %27 = load i32* %OuterIndex, align 4
  %28 = add nsw i32 %27, 1
  store i32 %28, i32* %OuterIndex, align 4
  br label %2
